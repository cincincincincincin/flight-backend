...
async def run_init(_app=None):
    ...
    countries_count = await db.fetch_val("SELECT COUNT(*) FROM countries")
    cities_count = await db.fetch_val("SELECT COUNT(*) FROM cities")
    airports_count = await db.fetch_val("SELECT COUNT(*) FROM airports")
    airlines_count = await db.fetch_val("SELECT COUNT(*) FROM airlines")
    routes_count = await db.fetch_val("SELECT COUNT(*) FROM routes")
    planes_count = await db.fetch_val("SELECT COUNT(*) FROM planes")
